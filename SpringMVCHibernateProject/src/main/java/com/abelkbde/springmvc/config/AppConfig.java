package com.abelkbde.springmvc.config;
...
@ComponentScan({"com.abelkbde.springmvc.config"})
public class AppConfig {
    ...
    public LocalSessionFactoryBean sessionFactory() {
        ...
        sessionFactory.setPackagesToScan(new String[] { "com.abelkbde.springmvc.model" });
